...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) {
    ...
    connect(m_analyzeButton, &QPushButton::clicked, m_canvas, &DrawingCanvas::analyzeImageWindows);
